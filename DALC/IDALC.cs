...
List<Teacher> Get_Teacher_By_Criteria_InList ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Teacher> Get_Teacher_By_Where_InList ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
List<Teacher> Get_Teacher_By_Criteria_InList_Adv ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
List<Teacher> Get_Teacher_By_Where_InList_Adv ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT);
...
Int32? Edit_Student ( Int32? STUDENT_ID, string FIRST_NAME, string LAST_NAME, string DOB, string EMAIL, bool? IS_BLOCKED, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID);
...
Int32? Edit_Teacher ( Int32? TEACHER_ID, string FIRST_NAME, string LAST_NAME, bool? IS_VALID, string EMAIL, string MOBILE, Int32? SCORE, bool? IS_BLOCKED, Int32? CATEGORY_ID, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID);
