...
o.My_Teacher.TEACHER_ID = GV<Int32>(R["T_TEACHER_TEACHER_ID"]);o.My_Teacher.FIRST_NAME = GV<String>(R["T_TEACHER_FIRST_NAME"]);o.My_Teacher.LAST_NAME = GV<String>(R["T_TEACHER_LAST_NAME"]);o.My_Teacher.IS_VALID = GV<Boolean>(R["T_TEACHER_IS_VALID"]);o.My_Teacher.EMAIL = GV<String>(R["T_TEACHER_EMAIL"]);o.My_Teacher.MOBILE = GV<String>(R["T_TEACHER_MOBILE"]);o.My_Teacher.SCORE = GV<Int32>(R["T_TEACHER_SCORE"]);o.My_Teacher.IS_BLOCKED = GV<Boolean>(R["T_TEACHER_IS_BLOCKED"]);o.My_Teacher.CATEGORY_ID = GV<Int32>(R["T_TEACHER_CATEGORY_ID"]);o.My_Teacher.ENTRY_USER_ID = GV<Int64>(R["T_TEACHER_ENTRY_USER_ID"]);o.My_Teacher.ENTRY_DATE = GV<String>(R["T_TEACHER_ENTRY_DATE"]);o.My_Teacher.OWNER_ID = GV<Int32>(R["T_TEACHER_OWNER_ID"]);
o.My_Student = new Student();
o.My_Student.STUDENT_ID = GV<Int32>(R["T_STUDENT_STUDENT_ID"]);o.My_Student.FIRST_NAME = GV<String>(R["T_STUDENT_FIRST_NAME"]);o.My_Student.LAST_NAME = GV<String>(R["T_STUDENT_LAST_NAME"]);o.My_Student.DOB = GV<String>(R["T_STUDENT_DOB"]);o.My_Student.EMAIL = GV<String>(R["T_STUDENT_EMAIL"]);o.My_Student.IS_BLOCKED = GV<Boolean>(R["T_STUDENT_IS_BLOCKED"]);o.My_Student.ENTRY_USER_ID = GV<Int64>(R["T_STUDENT_ENTRY_USER_ID"]);o.My_Student.ENTRY_DATE = GV<String>(R["T_STUDENT_ENTRY_DATE"]);o.My_Student.OWNER_ID = GV<Int32>(R["T_STUDENT_OWNER_ID"]);
}
return o;
}
...
o.My_Teacher = new Teacher();
o.My_Teacher.TEACHER_ID = GV<Int32>(X["T_TEACHER_TEACHER_ID"]);o.My_Teacher.FIRST_NAME = GV<String>(X["T_TEACHER_FIRST_NAME"]);o.My_Teacher.LAST_NAME = GV<String>(X["T_TEACHER_LAST_NAME"]);o.My_Teacher.IS_VALID = GV<Boolean>(X["T_TEACHER_IS_VALID"]);o.My_Teacher.EMAIL = GV<String>(X["T_TEACHER_EMAIL"]);o.My_Teacher.MOBILE = GV<String>(X["T_TEACHER_MOBILE"]);o.My_Teacher.SCORE = GV<Int32>(X["T_TEACHER_SCORE"]);o.My_Teacher.IS_BLOCKED = GV<Boolean>(X["T_TEACHER_IS_BLOCKED"]);o.My_Teacher.CATEGORY_ID = GV<Int32>(X["T_TEACHER_CATEGORY_ID"]);o.My_Teacher.ENTRY_USER_ID = GV<Int64>(X["T_TEACHER_ENTRY_USER_ID"]);o.My_Teacher.ENTRY_DATE = GV<String>(X["T_TEACHER_ENTRY_DATE"]);o.My_Teacher.OWNER_ID = GV<Int32>(X["T_TEACHER_OWNER_ID"]);
o.My_Student = new Student();
o.My_Student.STUDENT_ID = GV<Int32>(X["T_STUDENT_STUDENT_ID"]);o.My_Student.FIRST_NAME = GV<String>(X["T_STUDENT_FIRST_NAME"]);o.My_Student.LAST_NAME = GV<String>(X["T_STUDENT_LAST_NAME"]);o.My_Student.DOB = GV<String>(X["T_STUDENT_DOB"]);o.My_Student.EMAIL = GV<String>(X["T_STUDENT_EMAIL"]);o.My_Student.IS_BLOCKED = GV<Boolean>(X["T_STUDENT_IS_BLOCKED"]);o.My_Student.ENTRY_USER_ID = GV<Int64>(X["T_STUDENT_ENTRY_USER_ID"]);o.My_Student.ENTRY_DATE = GV<String>(X["T_STUDENT_ENTRY_DATE"]);o.My_Student.OWNER_ID = GV<Int32>(X["T_STUDENT_OWNER_ID"]);
oList.Add(o);
}
}
return oList;
...
public List<Teacher> Get_Teacher_By_Criteria_InList ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT)
{
List<Teacher> oList = new List<Teacher>();
dynamic p = new ExpandoObject();
p.FIRST_NAME = FIRST_NAME; p.LAST_NAME = LAST_NAME; p.EMAIL = EMAIL; p.MOBILE = MOBILE; p.CATEGORY_ID_LIST = string.Join(",", CATEGORY_ID_LIST.ToArray()); p.OWNER_ID = OWNER_ID; p.START_ROW = START_ROW; p.END_ROW = END_ROW; p.TOTAL_COUNT = TOTAL_COUNT;
...
public List<Teacher> Get_Teacher_By_Where_InList ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT)
{
List<Teacher> oList = new List<Teacher>();
dynamic p = new ExpandoObject();
p.FIRST_NAME = FIRST_NAME; p.LAST_NAME = LAST_NAME; p.EMAIL = EMAIL; p.MOBILE = MOBILE; p.CATEGORY_ID_LIST = string.Join(",", CATEGORY_ID_LIST.ToArray()); p.OWNER_ID = OWNER_ID; p.START_ROW = START_ROW; p.END_ROW = END_ROW; p.TOTAL_COUNT = TOTAL_COUNT;
...
public List<Teacher> Get_Teacher_By_Criteria_InList_Adv ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT)
{
List<Teacher> oList = new List<Teacher>();
dynamic p = new ExpandoObject();
p.FIRST_NAME = FIRST_NAME; p.LAST_NAME = LAST_NAME; p.EMAIL = EMAIL; p.MOBILE = MOBILE; p.CATEGORY_ID_LIST = string.Join(",", CATEGORY_ID_LIST.ToArray()); p.OWNER_ID = OWNER_ID; p.START_ROW = START_ROW; p.END_ROW = END_ROW; p.TOTAL_COUNT = TOTAL_COUNT;
...
public List<Teacher> Get_Teacher_By_Where_InList_Adv ( string FIRST_NAME, string LAST_NAME, string EMAIL, string MOBILE, List<Int32?> CATEGORY_ID_LIST, Int32? OWNER_ID, Int64? START_ROW, Int64? END_ROW,ref  Int64? TOTAL_COUNT)
{
List<Teacher> oList = new List<Teacher>();
dynamic p = new ExpandoObject();
p.FIRST_NAME = FIRST_NAME; p.LAST_NAME = LAST_NAME; p.EMAIL = EMAIL; p.MOBILE = MOBILE; p.CATEGORY_ID_LIST = string.Join(",", CATEGORY_ID_LIST.ToArray()); p.OWNER_ID = OWNER_ID; p.START_ROW = START_ROW; p.END_ROW = END_ROW; p.TOTAL_COUNT = TOTAL_COUNT;
...
public Int32? Edit_Student ( Int32? STUDENT_ID, string FIRST_NAME, string LAST_NAME, string DOB, string EMAIL, bool? IS_BLOCKED, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID)
{
Student oStudent = new Student();
oStudent.STUDENT_ID = STUDENT_ID;oStudent.FIRST_NAME = FIRST_NAME;oStudent.LAST_NAME = LAST_NAME;oStudent.DOB = DOB;oStudent.EMAIL = EMAIL;oStudent.IS_BLOCKED = IS_BLOCKED;oStudent.ENTRY_USER_ID = ENTRY_USER_ID;oStudent.ENTRY_DATE = ENTRY_DATE;oStudent.OWNER_ID = OWNER_ID;
...
public Int32? Edit_Teacher ( Int32? TEACHER_ID, string FIRST_NAME, string LAST_NAME, bool? IS_VALID, string EMAIL, string MOBILE, Int32? SCORE, bool? IS_BLOCKED, Int32? CATEGORY_ID, long? ENTRY_USER_ID, string ENTRY_DATE, Int32? OWNER_ID)
{
Teacher oTeacher = new Teacher();
oTeacher.TEACHER_ID = TEACHER_ID;oTeacher.FIRST_NAME = FIRST_NAME;oTeacher.LAST_NAME = LAST_NAME;oTeacher.IS_VALID = IS_VALID;oTeacher.EMAIL = EMAIL;oTeacher.MOBILE = MOBILE;oTeacher.SCORE = SCORE;oTeacher.IS_BLOCKED = IS_BLOCKED;oTeacher.CATEGORY_ID = CATEGORY_ID;oTeacher.ENTRY_USER_ID = ENTRY_USER_ID;oTeacher.ENTRY_DATE = ENTRY_DATE;oTeacher.OWNER_ID = OWNER_ID;
