...
#endregion
#region Get_Answer_By_QUESTION_ID_Adv
[HttpPost]
[Route("Get_Answer_By_QUESTION_ID_Adv")]
public Result_Get_Answer_By_QUESTION_ID_Adv Get_Answer_By_QUESTION_ID_Adv(Params_Get_Answer_By_QUESTION_ID i_Params_Get_Answer_By_QUESTION_ID)
{
#region Declaration And Initialization Section.
List<Answer>  oReturnValue = new List<Answer> ();
string i_Ticket = string.Empty;
Result_Get_Answer_By_QUESTION_ID_Adv oResult_Get_Answer_By_QUESTION_ID_Adv = new Result_Get_Answer_By_QUESTION_ID_Adv();
#endregion
#region Body Section.
try
{
...
oResult_Get_Answer_By_QUESTION_ID_Adv.My_Result = oReturnValue;
oResult_Get_Answer_By_QUESTION_ID_Adv.My_Params_Get_Answer_By_QUESTION_ID = i_Params_Get_Answer_By_QUESTION_ID;
}
}
catch(Exception ex)
{
if (ex.GetType().FullName != "BLC.BLCException")
{
oResult_Get_Answer_By_QUESTION_ID_Adv.ExceptionMsg = string.Format("Get_Answer_By_QUESTION_ID_Adv : {0}", ex.Message);
}
else
{
oResult_Get_Answer_By_QUESTION_ID_Adv.ExceptionMsg = ex.Message;
}
}
#endregion
#region Return Section
return oResult_Get_Answer_By_QUESTION_ID_Adv;
#endregion
}
#endregion
...
BLC.BLC oBLC_Default = new BLC.BLC();
BLCInitializer oBLCInitializer = oBLC_Default.Prepare_BLCInitializer(i_Ticket,BLC.BLC.Enum_API_Method.GetTopNTeachers);
using (BLC.BLC oBLC = new BLC.BLC(oBLCInitializer))
{
...
#endregion
#region Result_Get_Answer_By_QUESTION_ID_Adv
public partial class Result_Get_Answer_By_QUESTION_ID_Adv : Action_Result
{
#region Properties.
public List<Answer>  My_Result { get; set; }
public Params_Get_Answer_By_QUESTION_ID My_Params_Get_Answer_By_QUESTION_ID { get; set; }
#endregion
}
#endregion
